...
public class UserRegisterRequest {
	@NotBlank @Pattern(regexp = "^[a-z0-9]{4,10}$") private String username;
	@NotBlank @Size(min=8, max=15) @PasswordValid private String password;
	@NotBlank private String passwordConfirm;
	@NotBlank private String slackId;
	@NotBlank private String firstName;
	@NotBlank private String lastName;
	@NotBlank private String email;
	@NotBlank @PhoneValid private String phone;
}
