...
public enum UserMessageCode implements MessageCode {
	...
	MISSING_ORGANIZATION_ID("USER.MISSING_ORGANIZATION_ID", HttpStatus.INTERNAL_SERVER_ERROR),
	...
	USER_NOT_APPROVED("USER.USER_NOT_APPROVED", HttpStatus.FORBIDDEN),
	ORGANIZATION_ACCESS_DENIED("USER.ORGANIZATION_ACCESS_DENIED", HttpStatus.FORBIDDEN),
	;
